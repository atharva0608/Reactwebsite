...
const Skills = ({ canvasDetails }) => {
  const skillsList = [
    ...
    { name: "Grafana", img: "https://grafana.com/static/img/logos/grafana_logo.svg" },
    ...
    { name: "HashiCorp Consul", img: "https://images.seeklogo.com/logo-png/33/1/consul-logo-png_seeklogo-339775.png" },
